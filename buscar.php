...
$busqueda = ''; // Variable para almacenar la búsqueda
if (isset($_GET['busqueda'])) {
    $busqueda = $conexion->real_escape_string($_GET['busqueda']); // Sanitizar la entrada
}
...
<?php
if (!empty($busqueda)) {
    // Consulta a la base de datos para obtener productos que coincidan con la búsqueda
